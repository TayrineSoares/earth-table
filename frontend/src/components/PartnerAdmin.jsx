                ...
                return (
                  <Fragment key={row.id}>
                    ...
                    >
                      ...
                      <td>{formatCents(row.current_month_cash_cents)}</td>
                      <td>{formatCents(row.available_credit_cents)}</td>
                            ...
                            <div className="partner-month-list">
                              {months.map((month) => (
                                <div key={month.period} className="partner-month-card">
                                  <div className="partner-month-header">
                                    <strong>{month.label}</strong>
                                    <span>{formatMonthEarnSummary(month)}</span>
                                  </div>
